...
namespace BookList.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            // display dropdown for role and company
            Input = new InputModel
            {
                ...
                RoleList = _roleManager.Roles
                    .Where(u => u.Name != SD.Role_User_Indi)
                    .Select(x => x.Name)
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // only for develop - check if all roles exists and first user will be admin
                    ...
                    // если не выбрали роль, то как пользователь регистрируем
                    if(user.Role == null)
                    {
            ...
            // display dropdown for role and company
            // if we have some error, it will be display an error
            Input = new InputModel
            {
                CompanyList = _unitOfWork.Company.GetAll().Select(i => new SelectListItem
                {
